...
const ReviewsSection = () => {
  ...
  return (
    <section id="reviews" className="py-10 sm:py-12 md:py-16 lg:py-20 relative z-10 bg-primary/5 overflow-hidden">
        ...
        >
          <CarouselContent className="-ml-2 md:-ml-4">
            {reviews.map((review, i) => (
              ...
              >
                <article className="bg-card p-4 sm:p-5 md:p-6 rounded-xl border border-border relative transition-all hover:shadow-lg h-full flex flex-col">
                  <MessageCircle 
                    aria-hidden="true" 
                    className="absolute top-3 right-3 sm:top-4 sm:right-4 w-5 h-5 sm:w-6 sm:h-6 text-muted-foreground/30" 
                  />
