...
const ReviewsSection = () => {
  return (
    <section id="reviews" className="py-12 md:py-20 bg-primary/5 relative z-10">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
          {reviews.map((review, i) => (
            <div key={i} className="bg-card p-5 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl shadow-sm border border-border relative card-hover">
              ...
              <p className="text-muted-foreground mb-4 sm:mb-6 italic text-sm sm:text-base">"{review.quote}"</p>
