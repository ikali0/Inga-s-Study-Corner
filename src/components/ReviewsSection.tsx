...
const ReviewsSection = () => {
  return <section id="reviews" className="py-10 sm:py-12 md:py-16 lg:py-20 bg-primary/5 relative z-10">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 md:gap-6">
          {reviews.map((review, i) => <article key={i} className="bg-card p-4 sm:p-5 md:p-6 lg:p-8 rounded-xl shadow-sm border border-border relative card-hover sm:rounded-sm">
              <MessageCircle aria-hidden="true" className="absolute top-3 right-3 sm:top-4 sm:right-4 sm:top-6 md:right-6 text-primary/20 w-5 h-5 sm:w-6 sm:h-6 md:w-8 md:h-8 med:w-10 med:h-10" />
