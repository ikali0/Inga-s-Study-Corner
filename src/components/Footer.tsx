  ...
  return <footer className="bg-secondary text-secondary-foreground relative z-10 overflow-hidden py-10 md:py-14">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10 px-4 sm:px-6">
        ...
        <div className="sm:col-span-2 lg:col-span-1">
          ...
          <p className="text-secondary-foreground/80 leading-relaxed mb-4 text-xs">
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li>
              <button onClick={() => onNavigate('services')} className="text-secondary-foreground/70 hover:text-primary transition-colors text-xs">
                Tutoring Services
              </button>
            </li>
            <li>
