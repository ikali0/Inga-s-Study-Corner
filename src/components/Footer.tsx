      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 md:gap-10 px-4 sm:px-0">
        ...
        <div className="sm:col-span-2 lg:col-span-1">
          <h3 className="font-bold text-base sm:text-lg mb-2 sm:mb-3 md:mb-4 flex items-center gap-2">
            <Rocket size={20} className="bg-orange-300 text-pink-600 border-lime-100 border rounded-sm shadow-sm opacity-70 border-solid" />
            <span className="text-sm font-normal">Inga's Study Corner</span>
          </h3>
          ...
          <div className="flex items-center gap-2 text-secondary-foreground/70">
            ...
            <span className="text-xs sm:text-xs font-medium text-pink-600">Tue-Fri • 3:00-9:00 PM</span>
          </div>
        </div>
