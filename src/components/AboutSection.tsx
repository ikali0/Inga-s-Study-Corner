...
const AboutSection = () => {
  return <section id="about" className="py-10 sm:py-12 md:py-16 lg:py-20 relative z-10">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="bg-secondary rounded-xl sm:rounded-2xl md:rounded-3xl text-secondary-foreground p-4 sm:p-6 md:p-8 lg:p-12 xl:p-16 relative overflow-hidden">
        ...
        }} aria-hidden="true" className="absolute top-0 left-0 w-full h-full opacity-20" />
          ...
          <div className="relative z-10">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 md:gap-6">
              {features.map((feature, index) => <article key={index} className="flex gap-3 p-3 sm:p-4 rounded-lg border bg-lime-50 border-pink-600 sm:rounded-sm opacity-90 border-solid md:gap-[14px]">
