        ...
        <div className="bg-secondary rounded-xl sm:rounded-2xl md:rounded-3xl text-secondary-foreground p-4 sm:p-6 md:p-8 lg:p-12 xl:p-16 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 md:gap-6">
              {features.map((feature, index) => <article key={index} className="flex gap-3 md:gap-4 p-3 sm:p-4 rounded-lg sm:rounded-xl border border-secondary-foreground/10 bg-lime-50">
