...
const BookingSection = () => {
  ...
  return <section id="book" className="py-10 sm:py-12 md:py-16 lg:py-20 pb-16 sm:pb-20 md:pb-24 lg:pb-32 relative z-10">
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        ...
        <div className="bg-card rounded-xl sm:rounded-2xl md:rounded-3xl shadow-2xl p-4 sm:p-5 md:p-8 lg:p-10 xl:p-12 border border-border px-[40px] py-[40px] border-solid">
