...
const QuestionOfTheDay = () => {
  ...
  return <section className="py-8 font-sans sm:py-[46px] px-[14px]">
      <style>{`
        @keyframes shake {
        ...
        <Card className="overflow-hidden border-2 border-slate-200 shadow-xl bg-white transition-all duration-300">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="flex flex-col items-center gap-4 pt-2">
              ...
              {/* Result & Next Button */}
              {status !== "unanswered" && <div className="w-full text-center space-y-4 animate-in zoom-in-95 duration-300">
