  ...
  return <section id="hero" className="relative pt-28 pb-16 md:pt-32 md:pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
        <div className="space-y-6 md:space-y-8 z-10 order-2 md:order-1">
          ...
          <p className="text-lg md:text-xl text-muted-foreground font-medium max-w-lg text-left">
          ...
          <div className="flex-wrap gap-4 text-sm font-semibold text-muted-foreground flex items-start justify-center">
